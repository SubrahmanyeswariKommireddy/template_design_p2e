...
function MobileComponents() {
    ...
    return (
        <>
            ...
            <div className='max-w-sm m-auto text-center overflow-visible pb-24'>
                <div className='m-auto space-y-6'>
                    <div className='text-3xl pb-5 font-poppins font-semibold leading-normal'>
                    ...
                    <div className='flex flex-col items-center space-y-4'>
                        <input
                            type="text"
                            placeholder="Email"
                            className="border border-gray-300 rounded-md p-4 focus:outline-none w-full"
                        />
                        <button className="text-white bg-primary p-4 rounded hover:bg-black focus:outline-none font-medium underline w-full">
                            Get Started
                        </button>
                    </div>
            ...
            <div className="max-w-sm m-auto text-center overflow-visible space-y-6 pb-24">
                <div className="flex flex-col space-y-4 border-2 rounded-md shadow-xl p-10">
                <h2 className='font-poppins font-semibold text-left'>Trending</h2>
                ...
                <div className="flex flex-col space-y-4 border-2 ounded-md shadow-xl p-10">
                <h2 className='font-poppins font-semibold text-left'>Trending</h2>
                    <div className="flex flex-row space-x-3">
                        <h2 className="">1.</h2>
                        <img src='https://cdn.animaapp.com/projects/624bf82149c7baaee137f21d/releases/624c0e843d84adb832e1dcaf/img/bitcoin-icon@2x.png'
            ...
            <div className="max-w-sm m-auto text-center overflow-visible space-y-10 pb-24">
                <div className="font-poppins font-semibold text-4xl">Market Trends</div>
                <div className="flex flex-row justify-between text-grey font-poppins font-semibold">
                    <div>Name</div>
                    <div>Last Price</div>
                    <div>Change</div>
                </div>
                <div className="flex flex-row font-poppins justify-between text-grey">
                    ...
                    <div>$56,623.54</div>
                    <div className="text-green">+1.41%</div>
                </div>
            ...
            <div className='max-w-sm mx-auto flex flex-col text-center space-y-4 pb-24'>
                <div className="text-xl font-poppins font-semibold">Create the next generation crypto exchange website.</div>
                <p className="text-md font-poppins text-grey">Created with Figma and Anima. No coding involved.</p>
            </div>


            <div className='flex flex-col max-w-sm mx-auto justify-between overflow-visible pb-24' >
                {Array.map(() => {
                    return (
                        <>
                            <div className='flex flex-col shadow-lg rounded-md p-4 mx-auto space-y-8'>
            ...
            <div className='flex flex-col max-w-sm mx-auto justify-between overflow-visible space-y-4 pb-24' >
                {Array.map(() => {
                    return (
                        <>
            ...
            <div className='flex flex-col max-w-sm mx-auto justify-between overflow-visible space-y-6 pb-10' >
                {cardArr.map(() => {
                    return (
                        <>
                            <div>
            ...
            <div className='max-w-sm mx-auto text-center space-y-10 pb-6'>
        <div className='font-poppins text-4xl font-semibold '>Start Today. Easly</div>
        <button className="text-white bg-primary p-6 py-3 rounded hover:bg-black focus:outline-none underline font-poppins font-semibold w-full">
              Get Started
            </button>
      </div>


      <div className=' flex flex-col justify-between mx-20 max-w-full' >
        <div className="pb-14">
